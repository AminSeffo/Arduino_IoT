###########################################################################
## Makefile generated for component 'HSLS_Inbetriebnahme'. 
## 
## Makefile     : HSLS_Inbetriebnahme.mk
## Generated on : Wed Jul 21 12:56:21 2021
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/HSLS_Inbetriebnahme.elf
...
PRODUCT_NAME              = HSLS_Inbetriebnahme
MAKEFILE                  = HSLS_Inbetriebnahme.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2021a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2021a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Users/AMINSE~1/DOCUME~1/HSLS-IoT/HSLS_I~1/INBETR~1
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
SLIB_PATH                   = C:/Users/AMINSE~1/DOCUME~1/MATLAB/R2021a/ARDUIN~1/ARDUIN~1/FASTER~1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/HSLS_Inbetriebnahme.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021a/toolbox/target/SUPPOR~1/ARDUIN~2/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021a/toolbox/target/shared/svd/include -I$(START_DIR)/HSLS_Inbetriebnahme_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -I$(ARDUINO_SAMD_ROOT)/tools/CMSIS/$(SAMD_CMSIS_VERSION)/CMSIS/Include -I$(ARDUINO_SAMD_ROOT)/tools/CMSIS-Atmel/$(SAMD_CMSIS_ATMEL_VERSION)/CMSIS/Device/ATMEL -I$(ARDUINO_SAMD_ROOT)/hardware/samd/$(SAMD_LIB_VERSION)/cores/arduino -I$(ARDUINO_SAMD_ROOT)/hardware/samd/$(SAMD_LIB_VERSION)/variants/nano_33_iot -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021a/toolbox/target/SUPPOR~1/ARDUIN~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021a/toolbox/target/SUPPOR~1/ARDUIN~1/SCHEDU~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021a/toolbox/target/SUPPOR~1/ARMCOR~1/SCHEDU~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021a/toolbox/target/shared/EXTERN~1/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021a/toolbox/target/SUPPOR~1/ARMCOR~1/xcp/include -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021a/aIDE/LIBRAR~1/Servo/src -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021a/aIDE/portable/packages/arduino/hardware/samd/1835A9~1.9/LIBRAR~1/Wire -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021a/aIDE/portable/packages/arduino/hardware/samd/1835A9~1.9/LIBRAR~1/SPI -IC:/PROGRA~3/MATLAB/SUPPOR~1/R2021a/aIDE/LIBRAR~1/Servo/src/samd
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -D_MW_ARDUINO_LOOP_=1 -DMW_ARDUINO_STEP_SIZE=1000 -DMW_ARDUINO_MICROS -DARDUINO_NUM_SERIAL_PORTS=2 -D_RTT_BAUDRATE_SERIAL0_=115200 -D_RTT_BAUDRATE_SERIAL1_=115200 -D_RTT_ANALOG_REF_=0
...
DEFINES_STANDARD = -DMODEL=HSLS_Inbetriebnahme -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_arduino_digitalio.o MW_arduinoI2C.o MW_AnalogInput.o ArduinoPinHandleMap.o HSLS_Inbetriebnahme.o HSLS_Inbetriebnahme_data.o updown.o ext_work.o rtiostream_utils.o customPWM_wrapper.o MW_ArduinoHWInit.o io_wrappers.o arduinoARM_M0plusScheduler.o m0m1m0plus_multitasking.o rtiostream_interface.o ext_svr_daemon.o rtiostream_serial_daemon.o daemon_checksum.o
...
%.o : $(START_DIR)/HSLS_Inbetriebnahme_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/HSLS_Inbetriebnahme_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/HSLS_Inbetriebnahme_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/HSLS_Inbetriebnahme_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/HSLS_Inbetriebnahme_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
HSLS_Inbetriebnahme.o : $(START_DIR)/HSLS_Inbetriebnahme_ert_rtw/HSLS_Inbetriebnahme.c
	$(CC) $(CFLAGS) -o "$@" "$<"


HSLS_Inbetriebnahme_data.o : $(START_DIR)/HSLS_Inbetriebnahme_ert_rtw/HSLS_Inbetriebnahme_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/HSLS_Inbetriebnahme_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
customPWM_wrapper.o : $(START_DIR)/customPWM_wrapper.c
	$(CC) $(CFLAGS) -o "$@" "$<"
