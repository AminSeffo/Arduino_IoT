###########################################################################
## Makefile generated for component 'arduino_serial_send_println'. 
## 
## Makefile     : arduino_serial_send_println.mk
## Generated on : Sun Nov 07 19:22:46 2021
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/arduino_serial_send_println.elf
...
PRODUCT_NAME              = arduino_serial_send_println
MAKEFILE                  = arduino_serial_send_println.mk
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/arduino_serial_send_println.elf
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DMW_TIMERID=10 -DMW_PRESCALAR=512 -DMW_TIMERCOUNT=15625 -DMW_SCHEDULERCOUNTER=1 -DARDUINO_NUM_SERIAL_PORTS=2 -D_RTT_BAUDRATE_SERIAL0_=115200 -D_RTT_BAUDRATE_SERIAL1_=9600 -D_RTT_ANALOG_REF_=0
...
DEFINES_STANDARD = -DMODEL=arduino_serial_send_println -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_SerialRead.o MW_SerialWrite.o arduino_serial_send_println.o arduino_serial_send_println_data.o MW_ArduinoHWInit.o io_wrappers.o arduinoARM_M0plusScheduler.o m0m1m0plus_multitasking.o
...
%.o : $(START_DIR)/arduino_serial_send_println_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/arduino_serial_send_println_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/arduino_serial_send_println_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/arduino_serial_send_println_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/arduino_serial_send_println_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
arduino_serial_send_println.o : $(START_DIR)/arduino_serial_send_println_ert_rtw/arduino_serial_send_println.c
	$(CC) $(CFLAGS) -o "$@" "$<"


arduino_serial_send_println_data.o : $(START_DIR)/arduino_serial_send_println_ert_rtw/arduino_serial_send_println_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"


ert_main.o : $(START_DIR)/arduino_serial_send_println_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"
